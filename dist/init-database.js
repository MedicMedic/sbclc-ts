...
try {
  ...
  `);
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
  `).run("admin", "admin@sbclc.com", passwordHash, "System Administrator", "System", "Administrator", "admin", "IT");
  ...
  `);
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
  `).run("CLI001", "Sample Corporation", "John Doe", "john.doe@sample.com", "+63 912 345 6789", "123 Business St, Makati City, Metro Manila", "Net 30 Days", 1000000);
